...
package io.github.eknekron.mysticwoodstutorial.lwjgl3

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration
import io.github.eknekron.mysticwoodstutorial.MysticWoodsTutorial
...
fun main() {
    ...
    if (StartupHelper.startNewJvmIfRequired())
      return
    Lwjgl3Application(MysticWoodsTutorial(), Lwjgl3ApplicationConfiguration().apply {
        setTitle("MysticWoodsTutorial")
